...
1. InsightForge (deep insight retrieval) - The most powerful hybrid retrieval, automatically generates sub-questions and retrieves across multiple dimensions
...
class InsightForgeResult:
    ...
    Contains retrieval results from multiple sub-questions, along with comprehensive analysis
    """
    query: str
...
class ZepToolsService:
    ...
    2. panorama_search - Broad search (gets the full picture, including expired content)
    3. quick_search - Simple search (quick retrieval)
    4. interview_agents - In-depth interview (interviews simulated agents, obtains multi-perspective viewpoints)
    ...
    def _local_search(
        ...
        Fetches all edges/nodes, then performs keyword matching locally
    ...
    def get_all_nodes(self, graph_id: str) -> List[NodeInfo]:
        """
        Get all nodes in the graph (with pagination)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges in the graph (with pagination, includes temporal information)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Fetches all edges in the graph, then filters for those related to the specified node
    ...
    def get_simulation_context(
        ...
        # Search for information related to the simulation requirements
        search_result = self.search_graph(
            graph_id=graph_id,
        ...
        # Filter for entities with actual types (not pure Entity nodes)
        entities = []
        for node in all_nodes:
    ...
    def insight_forge(
        ...
        # Fetch details for all related entities (no quantity limit, full output)
        entity_insights = []
    ...
    def _generate_sub_queries(
        ...
        Decomposes a complex question into multiple sub-questions that can be independently retrieved
        """
...
Return the list of sub-questions in JSON format."""
    ...
    def panorama_search(
        ...
        3. Categorizes and organizes currently active and historical information
    ...
    def interview_agents(
        ...
        4. Calls the /api/simulation/interview/batch endpoint for real interviews (dual-platform simultaneous interviews)
        ...
        try:
            ...
            # Call SimulationRunner's batch interview method (no platform, dual-platform interviews)
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean up JSON tool call wrappers in agent responses and extract the actual content"""
