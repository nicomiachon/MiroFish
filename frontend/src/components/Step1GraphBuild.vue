    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, automatically chunks documents and calls Zep to build the knowledge graph, extracting entities and relationships, forming temporal memory and community summaries
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Construction Complete</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph construction is complete. Please proceed to the next step for simulation environment setup.</p>
          <button 
            class="action-btn" 
