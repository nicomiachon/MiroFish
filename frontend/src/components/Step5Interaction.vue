          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Select Conversation Partner</div>
                <div 
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat version of the report generation agent, with access to 4 professional tools and full MiroFish memory</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-based breadth-first traversal algorithm that reconstructs event propagation paths and captures the full topology of information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface with optimized indexing efficiency for rapid extraction of specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that conduct multi-round parallel conversations with simulated individuals to collect unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to explore the report in depth' : 'Chat with simulated individuals to learn their perspectives' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                ...
                <span class="selection-count">{{ selectedAgents.size }} / {{ profiles.length }} selected</span>
              </div>
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter the question you want to ask all selected recipients..."
                rows="3"
              ></textarea>
            </div>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Selected conversation partner: ${agent.username}`)
}
...
const renderMarkdown = (content) => {
  ...
  // Clean up <br> tags before and after block elements
  html = html.replace(/<br>\s*(<ul|<ol|<blockquote)/g, '$1')
  html = html.replace(/(<\/ul>|<\/ol>|<\/blockquote>)\s*<br>/g, '$1')
  // Clean up <p><br> immediately followed by block elements (caused by extra blank lines)
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Clean up consecutive <br> tags
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Clean up <br> between block elements and paragraph opening tags
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix non-consecutive ordered list numbering: maintain incrementing numbers when single-item <ol> elements are separated by paragraph content
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    // Convert object dictionary to array, prioritizing reddit platform responses
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prioritize reddit platform response, then twitter
...
const submitSurvey = async () => {
  ...
  addLog(`Sending survey to ${selectedAgents.value.size} recipients...`)
...
/* Quote styles for chat/survey areas */
